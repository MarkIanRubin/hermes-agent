...
user = generator("Generate user: Alice, 25, [REDACTED_EMAIL]")
print(user.name)   # "Alice"
print(user.age)    # 25
print(user.email)  # "[REDACTED_EMAIL]"
```
...
result = generator("Generate person: Alice, 25, [REDACTED_EMAIL]")
