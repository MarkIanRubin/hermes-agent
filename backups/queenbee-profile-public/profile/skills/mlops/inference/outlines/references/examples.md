...
She can be reached at [REDACTED_EMAIL] and currently lives in Cambridge, MA.
"""
...
Authors:
- Dr. Jane Smith ([REDACTED_EMAIL]), MIT
- Prof. John Doe ([REDACTED_EMAIL]), Stanford University
